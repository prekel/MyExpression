...
namespace Evaluation
{
	public class Evaluator
	{
        ...
        private string ReformExpression(string e)
        {
            ...
            sb.Replace(" ", "");
            sb.Replace("abs", "temp0");
            sb.Replace("acos", "temp1");
            sb.Replace("acosh", "temp2");
            sb.Replace("asin", "temp3");
            sb.Replace("asinh", "temp4");
            sb.Replace("atan", "temp5");
            sb.Replace("atan2", "temp6");
            sb.Replace("atanh", "temp7");
            sb.Replace("bigmul", "temp8");
            sb.Replace("cbrt", "temp9");
            ...
            sb.Replace("temp0", "Math.Abs");
            sb.Replace("temp1", "Math.Acos");
            sb.Replace("temp2", "Math.Acosh");
            sb.Replace("temp3", "Math.Asin");
            sb.Replace("temp4", "Math.Asinh");
            sb.Replace("temp5", "Math.Atan");
            sb.Replace("temp6", "Math.Atan2");
            sb.Replace("temp7", "Math.Atanh");
            sb.Replace("temp8", "Math.BigMul");
            sb.Replace("temp9", "Math.Cbrt");
